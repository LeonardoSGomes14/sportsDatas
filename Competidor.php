...
// Criar uma instância do CompetitorsController
$competitorController = new CompetitorController($pdo);

// Listar competidores
$competitors = $competitorController->listCompetitors();
?>
<!doctype html>
<html lang="pt-BR">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="delete-competidor.php?id=<?php echo htmlspecialchars($competitor['id_competitor']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir este competidor?');">Excluir</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
